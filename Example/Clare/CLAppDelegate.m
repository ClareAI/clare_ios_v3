...
//  Clare
//
//  Created by vernalclareai on 04/28/2020.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CLSettings *settings = [CLSettings initWithAppId:@"5d20bcefcddfff0010271fbd"];
    ...
    styleSetting.quickReplyButtonBorderColor = UIColor.blueColor;
